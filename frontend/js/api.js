...
class APIManager {
    constructor() {
        ...
        this.endpoints = {
            startGame: '/api/v1/captures/attempt',
            tap: '/api/v1/captures/attempt',
            getUserInfo: '/api/v1/users/{address}',
            getUserNFTs: '/api/v1/nfts/{address}',
            getNFTDetails: '/api/v1/nfts/token/{tokenId}',
            health: '/health',
            nftStats: '/api/v1/nfts/stats',
            recentNFTs: '/api/v1/nfts/recent',
            userStats: '/api/v1/users/{address}/stats',
    ...
    async getUserInfo(walletAddress) {
        ...
        const endpoint = `${this.endpoints.getUserInfo}/${walletAddress}`;
